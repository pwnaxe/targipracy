...
export interface ApiAboutAbout extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'About items with checkmarks';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
...
export interface ApiBanerBaner extends Struct.SingleTypeSchema {
  collectionName: 'baners';
  info: {
    description: 'Bottom notification banner';
    displayName: 'Baner';
    pluralName: 'baners';
    singularName: 'baner';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::baner.baner'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGaleriaGaleria extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Gallery with carousel images';
    displayName: 'Galeria';
    pluralName: 'galerias';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    karuzelas: Schema.Attribute.Media<'images', true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::galeria.galeria'
...
export interface ApiLogaFirmLogaFirm extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Company logos slider';
    displayName: 'Loga Firm';
...
export interface ApiNawigacjaNawigacja extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    agenda: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiOWydarzeniuTytulOWydarzeniuTytul
  extends Struct.SingleTypeSchema {
  collectionName: 'o_wydarzeniu_tytuls';
  info: {
    description: 'Title section for About Event';
    displayName: 'O Wydarzeniu Tytu\u0142';
    pluralName: 'o-wydarzeniu-tytuls';
    singularName: 'o-wydarzeniu-tytul';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    altTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::o-wydarzeniu-tytul.o-wydarzeniu-tytul'
    >;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiPartnershipPartnership extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Partnership section for employers';
...
export interface ApiStopkaStopka extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    firstEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    ...
    publishedAt: Schema.Attribute.DateTime;
    SecoundEmail: Schema.Attribute.Email & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::nawigacja.nawigacja': ApiNawigacjaNawigacja;
      'api::o-wydarzeniu-tytul.o-wydarzeniu-tytul': ApiOWydarzeniuTytulOWydarzeniuTytul;
